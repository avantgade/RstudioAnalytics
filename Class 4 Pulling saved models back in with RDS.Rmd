...
suppressPackageStartupMessages({
    ...
    library(RCurl) # General Network (HTTP/FTP/...) Client Intelrace for R
    library(DT) # A Wrapper of the JavaScript Library 'DataTables'
    library(moderf) # Modelling Functions that Work with the Pipe
    ...
    # library(dataxray) # An interactive table intelrace for data summaries
...
```{r}
# Load the model
LR_wflw_fit_final <- readRDS("C:/Advanced Analytics Project/00_Data/LR_model_for_attrition_2024.rds")
```

# Reload the test results

```{r}
LR_test_results <- readRDS("C:/Advanced Analytics Project/00_Data/LR_test_results_for_attrition_2024.rds")
```
